...
export default defineComponent({
    ...
    props: {
         ...
         */
        path: { type: [String, Boolean] as PropType<string | false>, default: false },
        /**
         ...
         */
        baseDirectoryLabel: { type: [String, Boolean] as PropType<string | false>, default: false },
        /**
         ...
         */
        onSegmentClick: {
            type: [Function, Boolean] as PropType<((segment: { location: string }) => void) | false>,
            default: false,
        },
    },
    data() {
