...
export default defineComponent({
    ...
    computed: {
        historyPrinttimeAvg(): EChartRef | undefined {
            return this.$refs.historyPrinttimeAvg as EChartRef | undefined
        },
    ...
    watch: {
        printtimeAvgArray(newVal: number[]) {
