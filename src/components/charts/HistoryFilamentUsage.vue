...
export default defineComponent({
    ...
    mixins: [BaseMixin, HistoryMixin, ThemeMixin],
    computed: {
        historyFilamentUsage(): EChartRef | undefined {
            return this.$refs.historyFilamentUsage as EChartRef | undefined
        },
        ...
        filamentUsageArray(): [number, number][] {
    ...
    watch: {
        filamentUsageArray(newVal: [number, number][]) {
