...
export default defineComponent({
    name: 'HeightmapChart',
    mixins: [BaseMixin, BedmeshMixin, ThemeMixin],
    props: {
        showProbed: { type: Boolean, default: false },
        showMesh: { type: Boolean, default: false },
        showFlat: { type: Boolean, default: false },
        wireframe: { type: Boolean, default: false },
        scaleGradient: { type: Boolean, default: false },
        scaleZMax: { type: Number, default: 1 },
    },
    computed: {
        chart(): ECharts | null {
            return (this.$refs.heightmap as EChartRef | undefined)?.chart ?? null
        },
        ...
        chartOptions() {
            return {
                ...
                darkMode: this.$vuetify.theme.current.dark,
                animation: false,
                legend: {
                    show: false,
        ...
        selected(): Record<'probed' | 'mesh' | 'flat', boolean> {
            return {
