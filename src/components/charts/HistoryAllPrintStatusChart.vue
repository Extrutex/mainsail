...
export default defineComponent({
    ...
    mixins: [BaseMixin, ThemeMixin, HistoryStatsMixin],
    props: {
        valueName: { type: String, default: 'jobs' },
    },
    computed: {
        historyAllPrintStatus(): EChartRef | undefined {
            return this.$refs.historyAllPrintStatus as EChartRef | undefined
        },
    ...
    watch: {
        groupedPrintStatusArray(newVal: ServerHistoryStateAllPrintStatusEntry[]) {
