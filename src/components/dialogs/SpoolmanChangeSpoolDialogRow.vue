<template>
    <tr class="cursor-pointer" @click="setSpoolRow">
        ...
        <td class="py-2" style="min-width: 300px">
            <v-list-item lines="two" class="no--padding">
...
export default defineComponent({
    name: 'SpoolmanChangeSpoolDialogRow',
    mixins: [BaseMixin, AfcMixin],
    props: {
        spool: { type: Object as PropType<ServerSpoolmanStateSpool>, required: true },
        max_id_digits: { type: Number, required: false, default: 0 },
    },
    emits: ['set-spool'],
    computed: {
        color() {
