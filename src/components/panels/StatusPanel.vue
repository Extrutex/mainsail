    ...
    <div>
        ...
        <panel
            ...
            <template #buttons>
                ...
                <v-menu v-if="multiFunctionButton" left location="bottom" :close-on-content-click="false" class="pa-0">
                    <template #activator="{ props }">
            ...
            <status-panel-exclude-object v-model:show-dialog="boolShowObjects" @update:showDialog="updateShowDialog" />
            ...
            <v-tabs-window v-model="activeTab" class="_border-radius">
                <v-tabs-window-item v-if="current_filename" value="status">
                    <status-panel-printstatus />
                </v-tabs-window-item>
                <v-tabs-window-item v-if="displayFilesTab" value="files">
                    <status-panel-gcodefiles />
                </v-tabs-window-item>
                <v-tabs-window-item v-if="displayHistoryTab" value="history">
                    <status-panel-history />
                </v-tabs-window-item>
                <v-tabs-window-item value="jobqueue">
...
export default defineComponent({
    ...
    computed: {
            ...
            if (this.printer_state !== '') {
                ...
                if (this.printer_state !== '' && ['paused', 'printing'].includes(this.printer_state)) {
                    return (
                        this.printPercent +
                        '% ' +
                        this.printer_state.charAt(0).toUpperCase() +
                        this.printer_state.slice(1)
                    )
                }
        ...
        multiFunctionMenuButtonsFiltered() {
    ...
    watch: {
        current_filename(newVal: string) {
