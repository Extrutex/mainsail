            ...
            <v-menu v-if="showButtons" location="bottom end" :close-on-content-click="false" class="pa-0">
                ...
                <v-list density="compact">
                    ...
                    <v-list-item v-if="existsBedScrews">
                        <v-btn size="small" style="width: 100%" @click="doSend('BED_SCREWS_ADJUST')">
                            BED SCREWS ADJUST
                        </v-btn>
                    </v-list-item>
                    <v-list-item v-if="existsDeltaCalibrate">
                        <v-btn size="small" style="width: 100%" @click="doSend('DELTA_CALIBRATE')">
                            DELTA CALIBRATE
                        </v-btn>
                    </v-list-item>
                                ...
                                <v-list density="compact">
                                    <v-list-item>
                                        <v-btn
                                            ...
                                            <v-icon start size="small" style="transform: scaleX(-1)">
                                                {{ mdiRestore }}
                                            </v-icon>
                                            <span>CW</span>
                                        </v-btn>
