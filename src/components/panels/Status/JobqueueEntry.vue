<template>
    <v-row
        ...
        <v-col v-if="showHandle" cols="auto" class="d-flex flex-column justify-center pr-0 py-0">
...
export default defineComponent({
    name: 'StatusPanelJobqueueEntry',
    components: { GcodefilesThumbnail, JobqueueEntryChangeCountDialog },
    mixins: [BaseMixin],
    props: {
